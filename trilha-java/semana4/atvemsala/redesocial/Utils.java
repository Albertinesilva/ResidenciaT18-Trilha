...
public class Utils {
  ...
  public void redeSocial() {
    ...
    usuarios.carregarDeArquivo("trilha-java/semana4/atvemsala/redesocial/bancodedados/redesocial.txt");
    ...
    do {
      ...
      switch (opcao) {
        ...
        case 1:
          ...
          usuarios.salvarEmArquivo("trilha-java/semana4/atvemsala/redesocial/bancodedados/redesocial.txt");
          break;
