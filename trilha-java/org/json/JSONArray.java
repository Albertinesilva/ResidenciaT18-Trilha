...
public class JSONArray implements Iterable<Object> {
     ...
     *
     * @throws JSONException
     *                              If not an array or if an array value is
     *                              non-finite number.
    ...
    /**
     * Get the optional JSONArray associated with an index. The defaultValue is
     * returned if
     * there is no value at that index or if the value is not a JSONArray.
     *
     * @param index
    ...
    /**
     * Get the optional JSONObject associated with an index. The defaultValue is
     * returned if
     * there is no value at that index or if the value is not a JSONObject.
     *
     * @param index
     ...
     *         reference to self
     * @throws JSONException
     *                              If the index is negative or if the value is an
     *                              invalid
     *                              number.
     * @throws NullPointerException
     *                              If a key in the map is <code>null</code>
     ...
     *
     * @param array
     *              Array. If the parameter passed is null, or not an array or
     *              Iterable, an
     *              exception will be thrown.
     * @return this.
     *
     * @throws JSONException
     *                              If not an array, JSONArray, Iterable or if an
     *                              value is non-finite number.
     * @throws NullPointerException
     *                              Thrown if the array parameter is null.
     */
     ...
     *                       A Collection.
     * @param wrap
     *                       {@code true} to call {@link JSONObject#wrap(Object)}
     *                       for each item,
     *                       {@code false} to add the items directly
     * @param recursionDepth
     *                       Variable for tracking the count of nested object
     *                       creations.
     */
     ...
     *             An Iterable.
     * @param wrap
     *             {@code true} to call {@link JSONObject#wrap(Object)} for each
     *             item,
     *             {@code false} to add the items directly
     */
     ...
     *              {@code false} to add the items directly
     * @throws JSONException
     *                       If not an array or if an array value is non-finite
     *                       number.
     */
     ...
     *
     * @param array
     *                       Array. If the parameter passed is null, or not an
     *                       array,
     *                       JSONArray, Collection, or Iterable, an exception will
     *                       be
     *                       thrown.
     * @param wrap
     *                       {@code true} to call {@link JSONObject#wrap(Object)}
     ...
     * 
     * @param array
     *                                Array. If the parameter passed is null, or not
     *                                an array,
     *                                JSONArray, Collection, or Iterable, an
     *                                exception will be
     *                                thrown.
     * @param wrap
     *                                {@code true} to call
     *                                {@link JSONObject#wrap(Object)} for each item,
     *                                {@code false} to add the items directly
     * @param recursionDepth
     *                                Variable for tracking the count of nested
     *                                object creations.
