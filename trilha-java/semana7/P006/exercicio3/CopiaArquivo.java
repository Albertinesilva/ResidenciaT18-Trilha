...
public class CopiaArquivo {
  ...
  public static void main(String[] args) {
    ...
    String caminhoOrigem = "trilha-java/semana7/P006/exercicio3/bancodedados/origem.txt";
    String caminhoDestino = "trilha-java/semana7/P006/exercicio3/bancodedados/destino.txt";
