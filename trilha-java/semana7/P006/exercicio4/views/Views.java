...
import P006.exercicio4.repositories.CobradorRepository;
import P006.exercicio4.repositories.JornadaRepository;
import P006.exercicio4.repositories.MotoristaRepository;
import P006.exercicio4.repositories.PassageiroRepository;
import P006.exercicio4.repositories.PontoDeParadaRepository;
import P006.exercicio4.repositories.TrajetoRepository;
import P006.exercicio4.repositories.VeiculoRepository;
import P006.exercicio4.services.CobradorService;
import P006.exercicio4.services.JornadaService;
import P006.exercicio4.services.MotoristaService;
import P006.exercicio4.services.PassageiroService;
import P006.exercicio4.services.PontoDeParadaService;
import P006.exercicio4.services.TrajetoService;
import P006.exercicio4.services.VeiculoService;
...
public class Views {
  ...
  private void menuCobrador() {
    ...
    int opcao = -1;
    cobradorRepository.carregarArquivo("trilha-java\\semana7\\P006\\exercicio4\\bancodedados\\cobrador.txt"); 
    ...
    do {
      ...
      switch (opcao) {
        case 1:
          ...
          cobradorRepository.salvarArquivo("trilha-java\\semana7\\P006\\exercicio4\\bancodedados\\cobrador.txt");
  ...
  private void menuMotoristas() {
    ...
    int opcao = -1;
    motoristaRepository.carregarArquivo("trilha-java\\semana7\\P006\\exercicio4\\bancodedados\\motorista.txt");
    ...
    do {
      ...
      switch (opcao) {
        case 1:
          ...
          motoristaRepository.salvarArquivo("trilha-java\\semana7\\P006\\exercicio4\\bancodedados\\motorista.txt");
          break;
  ...
  private void menuVeiculos() {
    ...
    int opcao = -1;
    veiculoRepository.carregarArquivo("trilha-java\\semana7\\P006\\exercicio4\\bancodedados\\veiculo.txt");
    ...
    do {
      ...
      switch (opcao) {
        case 1:
          ...
          veiculoRepository.salvarArquivo("trilha-java\\semana7\\P006\\exercicio4\\bancodedados\\veiculo.txt");
          break;
  ...
  private void menuPassageiros() {
    ...
    int opcao = -1;
    passageiroRepository.carregarArquivo("trilha-java\\semana7\\P006\\exercicio4\\bancodedados\\passageiro.txt");
    ...
    do {
      ...
      switch (opcao) {
        case 1:
          ...
          passageiroRepository.salvarArquivo("trilha-java\\semana7\\P006\\exercicio4\\bancodedados\\passageiro.txt");
          break;
  ...
  private void menuPontosDeParada() {
    ...
    int opcao = -1;
    pontoDeParadaRepository.carregarArquivo("trilha-java\\semana7\\P006\\exercicio4\\bancodedados\\pontodeparada.txt");
    ...
    do {
      ...
      switch (opcao) {
        ...
        pontoDeParadaRepository.salvarArquivo("trilha-java\\semana7\\P006\\exercicio4\\bancodedados\\pontodeparada.txt");
          break;
  ...
  private void menuTrajetos() {
    ...
    int opcao = -1;
    trajetoRepository.carregarArquivo("trilha-java\\semana7\\P006\\exercicio4\\bancodedados\\trajeto.txt");
    pontoDeParadaRepository.carregarArquivo("trilha-java\\semana7\\P006\\exercicio4\\bancodedados\\pontodeparada.txt");
    ...
    do {
      ...
      switch (opcao) {
        case 1:
          ...
          trajetoRepository.salvarArquivo("trilha-java\\semana7\\P006\\exercicio4\\bancodedados\\trajeto.txt");
          break;
